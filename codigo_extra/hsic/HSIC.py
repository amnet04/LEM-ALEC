...
def HSIC_conditional_pval(X, Y,HTresh, N_samp=500, kernelX="Gaussian", kernelY="Gaussian", eta = 0.001, 
              sigmaX=None, sigmaY=None,
              p_method="boots", return_boots=False):
    """ Calculates HSIC and p-value 
...
def HSIC_no_pval(X, Y, N_samp=500, kernelX="Gaussian", kernelY="Gaussian", eta = 0.001, 
              sigmaX=None, sigmaY=None,
              p_method="boots", return_boots=False):
    """ Calculates HSIC and p-value 
...
def HSIC_no_pval_X(centered_A, Y, N_samp=500, kernelX="Gaussian", kernelY="Gaussian", eta = 0.001, 
              sigmaX=None, sigmaY=None,
              p_method="boots", return_boots=False):
